...
namespace SDX_TD
{
	...
	class SceneMain : public SDX::IScene
	{
	public:
		//@Define
		UI_Frame 難易度情報 = { 352, {62,258,300,216} , 0.000000,5};
		UI_Frame ステージ一覧 = { 353, {362,258,276,154} , 0.000000,5};
		UI_Button 開始 = { 354, {365,414,272,60} , 0.000000,3};
		UI_Button 難易度－ = { 355, {83,266,40,40} , 0.000000,3};
		UI_Button 難易度＋ = { 356, {302,266,40,40} , 0.000000,3};
		UI_Frame ウィッチ一覧 = { 357, {62,2,300,256} , 0.000000,5};
		UI_Frame マップ情報 = { 358, {362,2,276,256} , 0.000000,5};
		UI_Button 面数Minus = { 359, {368,263,40,144} , 0.000000,3};
		UI_Button ステージA = { 360, {415,264,170,36} , 0.000000,1};
		UI_Button ステージB = { 361, {415,300,170,36} , 0.000000,1};
		UI_Button ステージC = { 362, {415,336,170,36} , 0.000000,1};
		UI_Button ステージD = { 363, {415,372,170,36} , 0.000000,1};
		UI_Button 面数Plus = { 364, {592,263,40,144} , 0.000000,3};
		UI_Frame 難易度 = { 365, {128,266,167,40} , 0.000000,5};
		UI_Text Wave数 = { 366, {250,349,60,25} , 0.000000,1,"25 Wave"};
		UI_Text 出現数 = { 367, {251,379,60,25} , 0.000000,1,"敵数 1.2倍"};
		UI_Text HP補正 = { 368, {251,409,60,24} , 0.000000,1,"HP　1.2倍"};
		UI_Text Lv補正 = { 369, {252,439,60,24} , 0.000000,1,"LV 1.5倍"};
		UI_Frame ウィッチアイコン = { 370, {68,32,20,20} , 0.000000,0};
		UI_Button シングル_カップル = { 371, {213,311,130,30} , 0.000000,3};
		UI_Button スキル = { 372, {83,311,130,30} , 0.000000,3};
		UI_Text ウィッチ名 = { 373, {96,32,56,20} , 0.000000,0,"std::string"};
		UI_Text 星 = { 374, {155,31,21,21} , 0.000000,0,"std::string"};
		UI_Text スコア = { 375, {278,32,30,22} , 0.000000,2,"std::string"};
		UI_Text ハイスコア = { 376, {64,9,126,22} , 0.000000,2,"Hi Score"};
		//@End
...
#endif
			//@Load
			SDX::GUIData guiData = SDX::TMXtoGUI( TMX_FILE_NAME , "SceneMain", GUI_Factory);
